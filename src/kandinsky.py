...
data_url = "https://github.com/glouwa/app-kandinsky-pattern-generator/raw/master/kandinsky_color_large.tar.gz"
...
def load():
    ...
    cache_path = os.path.join(data_dir, "kandinsky.pkl")
